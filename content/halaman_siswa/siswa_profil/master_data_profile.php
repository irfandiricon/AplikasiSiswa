...
$q1 = "SELECT a.*,c.id as id_sekolah, c.nama as nama_sekolah, c.alamat as alamat_sekolah, c.no_telpon as no_telepon_sekolah,
    d.user_id as user_id_guru, d.user_id_login as user_id_login_guru, d.nama_lengkap as nama_guru
    ...
    LEFT JOIN $db.$table_guru as d ON a.id_guru = d.user_id
...
$kelas = isset($r1['kelas']) ? $r1['kelas']:0;
$nama_guru = $r1['nama_guru'];
$user_id_login_guru = $r1['user_id_login_guru'];
$user_id_guru = $r1['user_id_guru'];
