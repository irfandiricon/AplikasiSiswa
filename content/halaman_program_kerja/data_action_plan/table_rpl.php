...
header("Content-Disposition: attachment;Filename=E-Administrasi-BK.doc");
...
?>
<table class="table table-hover table-striped table-bordered" border="1" style="padding:10px;">
    <thead>
        <tr>
            <td>No</td>
