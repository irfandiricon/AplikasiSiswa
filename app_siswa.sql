...
/*Data for the table `app_download` */

insert  into `app_download`(`id`,`nama_file`,`path_file`,`created_date`,`created_by`) values (1,'RASIONAL APLIKASI','rasional_aplikasi.docx','2018-10-07 19:11:38',1),(2,'DASAR HUKUM','dasar_hukum.docx','2018-10-07 19:13:09',1),(3,'VISI DAN MISI BK','visi_dan_misi_bk.docx','2018-10-07 19:13:49',1),(4,'COVER','cover.docx','2018-10-07 19:15:25',1),(5,'KOMPONEN PROGRAM','komponen_program.docx','2018-10-07 19:17:06',1),(6,'BIDANG LAYANAN','bidang_layanan.docx','2018-10-07 19:20:02',1),(7,'JADWAL KEGIATAN BK','jadwal_kegiatan_bk.docx','2018-10-07 19:21:35',1),(8,'RENCANA EVALUASI','rencana_evaluasi.docx','2018-10-07 19:21:48',1),(9,'RENCANA ANGGARAN','rencana_anggaran.docx','2018-10-07 19:22:05',1);
...
CREATE TABLE `app_guru` (
  ...
  `flag_aktif` enum('Y','N') DEFAULT 'N',
  PRIMARY KEY (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*Data for the table `app_guru` */

insert  into `app_guru`(`user_id`,`user_id_login`,`nip`,`nama_lengkap`,`tempat_lahir`,`tanggal_lahir`,`jenis_kelamin`,`alamat`,`email`,`no_telp`,`id_sekolah`,`created_date`,`created_by`,`updated_date`,`updated_by`,`deleted_date`,`deleted_by`,`flag_aktif`) values (3,6,'','Guru 1','Padang','2018-09-09','','','guru_1@gmail.com','021',10,'2018-09-03 00:57:18',NULL,'2018-09-17 00:11:39',6,NULL,NULL,'Y'),(4,7,NULL,'Guru 2',NULL,'0000-00-00',NULL,NULL,'guru_2@gmail.com','022',NULL,'2018-09-03 00:57:36',NULL,NULL,NULL,'2018-09-17 00:09:49',9,'N'),(5,8,NULL,'Guru 3',NULL,'0000-00-00',NULL,NULL,'guru_3@gmail.com','023',NULL,'2018-09-03 00:57:50',NULL,'2018-09-03 00:58:23',1,'2018-09-17 00:09:47',9,'N'),(6,10,NULL,'Guru 4',NULL,'0000-00-00',NULL,NULL,'guru4@gmail.com','0121213131',NULL,'2018-09-16 23:40:33',NULL,NULL,NULL,'2018-09-17 00:09:44',9,'N'),(7,11,'0121123131','Guru 5','Jakarta','1967-09-17','L','Jakarta','guru5@gmail.com','02123113213',10,'2018-09-17 00:07:53',NULL,'2018-09-17 00:15:47',11,NULL,NULL,'Y'),(8,14,NULL,'Guru 6',NULL,'0000-00-00',NULL,NULL,'guru6@gmail.com','123',10,'2018-09-17 01:21:21',NULL,'2018-09-17 01:55:02',9,NULL,NULL,'Y');

/*Table structure for table `app_home` */

DROP TABLE IF EXISTS `app_home`;

CREATE TABLE `app_home` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `judul` char(200) DEFAULT NULL,
  `isi` text,
  `created_date` date DEFAULT NULL,
  `created_by` int(11) DEFAULT NULL,
  `updated_date` date DEFAULT NULL,
...
insert  into `app_menu`(`id_menu`,`id_group_menu`,`nama_menu`,`path`,`nama_file`,`created_date`,`created_by`,`updated_date`,`updated_by`,`deleted_date`,`deleted_by`,`flag_aktif`) values (1,1,'Pengaturan Menu','setting/app_menu','index.php','2018-08-04 13:32:31',1,NULL,NULL,NULL,NULL,'Y'),(4,3,'Master Akses','content/app_menu','index.php','2018-08-10 19:21:23',1,NULL,NULL,NULL,NULL,'Y'),(7,6,'Data Siswa','content/master_data_siswa','index.php','2018-08-11 06:30:41',1,NULL,NULL,NULL,NULL,'Y'),(8,6,'Data Guru','content/master_data_guru','index.php','2018-08-11 06:31:12',1,NULL,NULL,NULL,NULL,'Y'),(9,6,'Data Sekolah','content/master_data_sekolah','index.php','2018-08-11 06:33:27',1,NULL,NULL,NULL,NULL,'Y'),(10,6,'Data Instrumen','content/master_data_pertanyaan','index.php','2018-08-15 21:19:22',1,NULL,NULL,NULL,NULL,'Y'),(11,7,'Home','content/home','index.php','2018-09-21 20:30:43',1,NULL,NULL,NULL,NULL,'Y'),(12,7,'Tentang Kami','content/about','index.php','2018-09-21 20:31:24',1,NULL,NULL,NULL,NULL,'Y'),(13,7,'Cara Pendaftaran','content/support','index.php','2018-10-06 17:19:34',1,NULL,NULL,NULL,NULL,'Y'),(14,7,'Pesan Masuk','content/message','index.php','2018-10-07 07:27:09',1,NULL,NULL,NULL,NULL,'Y'),(15,6,'Data Download','content/download','index.php','2018-10-07 09:09:52',1,NULL,NULL,NULL,NULL,'Y');
...
insert  into `app_menu_group`(`id_group_menu`,`font_icon`,`nama_group_menu`,`created_date`,`created_by`,`updated_date`,`updated_by`,`deleted_date`,`deleted_by`,`flag_aktif`) values (1,'fa fa-desktop','Pengaturan','2018-08-04 13:30:15',NULL,NULL,NULL,NULL,NULL,'Y'),(6,'fa fa-book','Pusat Data','2018-08-11 06:28:45',1,NULL,NULL,NULL,NULL,'Y'),(7,'fa fa-book','Portal Berita','2018-09-21 20:28:37',1,NULL,NULL,NULL,NULL,'Y');
...
insert  into `app_siswa`(`user_id`,`user_id_login`,`nis`,`nama_lengkap`,`tempat_lahir`,`tanggal_lahir`,`jenis_kelamin`,`alamat`,`email`,`no_telp`,`id_sekolah`,`kelas`,`id_guru`,`created_date`,`created_by`,`updated_date`,`updated_by`,`deleted_date`,`deleted_by`,`flag_aktif`) values (1,2,'','Afa','Padang','2018-09-02','P','','afa@gmail.com','021',10,'10',3,'2018-09-01 03:52:14',NULL,'2018-09-16 21:19:35',6,NULL,NULL,'Y'),(2,3,'11101152630092','Lilis','Padang','2018-09-03','P','Ciater Raya','2@gmail.com','021',10,'10',3,'2018-09-01 03:52:58',NULL,'2018-09-16 21:20:17',6,NULL,NULL,'Y'),(3,4,'','Guru 1','padang','1993-01-19','L','data','guru_1@gmail.com','021',10,'',3,'2018-09-01 03:55:04',NULL,'2018-09-06 23:08:06',6,'2018-09-03 00:50:01',1,'N'),(4,5,'','Masitoh noer ','','2018-09-11','','','4@gmail.com','021',10,'10',3,'2018-09-01 03:55:41',NULL,'2018-09-16 21:20:21',6,'2018-09-17 00:09:33',9,'N'),(5,12,'','Siswa 1','','0000-00-00','','','siswa1@gmail.com','123535353',10,'10',8,'2018-09-17 00:16:36',NULL,'2018-09-17 01:55:22',14,NULL,NULL,'Y'),(6,13,'','Siswa 2','','0000-00-00','','','siswa2@gmail.com','1234',10,'11',3,'2018-09-17 00:22:29',NULL,'2018-09-17 00:29:35',6,NULL,NULL,'Y');
