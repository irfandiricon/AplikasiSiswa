$(function (){
    ...
    $('#dg_access_menu').datagrid({
        ...
        width : wTbl,
        pageSize:20,
        url:'setting/master/master_data_user.php',
        columns:[[
            {field:'user',title:'USERNAME',width:50,sortable:true},
            {field:'nik',title:'NIK',width:40,sortable:true},
            {field:'nama',title:'NAMA USER',width:90,sortable:true},
            {field:'jabatan',title:'JABATAN',width:70,sortable:true},
            {field:'nama_kantor',title:'KANTOR CABANG / KAS',width:70,sortable:true}
        ]],
        rownumbers:true,
        onClickRow : function(){
...
function addMenuAccess(){
    ...
    $('<div/>').attr('id','addMenuAccess').appendTo($('body')).dialog({
        href: 'setting/app_access/form_access_menu.php',
        ...
        onLoad : function (){
            ...
            $('#duplikasi_access').combobox({
                url:'setting/access_menu/data_user.php',
                valueField:'user_id',
                textField:'nama',
                panelHeight:'auto',
                queryParams : {
