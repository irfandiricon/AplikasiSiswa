$(function (){
    ...
    $('#dg_group_menu').datagrid({
        ...
        onExpandRow: function(index,row){
            ...
            ddv.datagrid({
                url:'setting/master/master_data_menu.php',
                fitColumns:true,
                title: 'Menu',
                singleSelect:true,
                rownumbers:true,
...
function tambahGroupMenu(){
    ...
    $('<div/>').attr('id','addGroupMenu').appendTo($('body')).dialog({
        href: 'setting/app_menu/form_add_group_menu.php',
...
function editGroupMenu(){
    ...
    $('<div/>').attr('id','editGroupMenu').appendTo($('body')).dialog({
        href: 'setting/app_menu/form_edit_group_menu.php',
...
function tambahMenu(id_group_menu){
    ...
    $('<div/>').attr('id','addMenu').appendTo($('body')).dialog({
        href: 'setting/app_menu/form_add_menu.php',
        title: ' Tambah Menu',
        iconCls : "icon-add",
        top : 20,
        width: 400,
...
function editMenu(id_group_menu){
    ...
    $('<div/>').attr('id','editMenu').appendTo($('body')).dialog({
        href: 'setting/app_menu/form_edit_menu.php',
        title: ' Edit Menu',
        iconCls : "icon-edit",
        top : 20,
        width: 400,
